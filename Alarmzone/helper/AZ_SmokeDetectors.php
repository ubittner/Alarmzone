...
trait AZ_SmokeDetectors
{
     ...
     *
     * @param int $SmokeDetectorDeterminationType
     * @return void
     */
    public function CheckSmokeDetectorDeterminationValue(int $SmokeDetectorDeterminationType): void
    {
        $profileSelection = false;
        $determinationValue = false;
        //Profile selection
        if ($SmokeDetectorDeterminationType == 0) {
            $profileSelection = true;
        }
        //Custom ident
        if ($SmokeDetectorDeterminationType == 2) {
            $this->UpdateFormfield('SmokeDetectorDeterminationValue', 'caption', 'Identifikator');
            $determinationValue = true;
        }
        $this->UpdateFormfield('SmokeDetectorDeterminationProfileSelection', 'visible', $profileSelection);
        $this->UpdateFormfield('SmokeDetectorDeterminationValue', 'visible', $determinationValue);
    }

    /**
     * Determines the smoke detector variables.
     *
     ...
     * @throws Exception
     */
    public function DetermineSmokeDetectorVariables(int $DeterminationType, string $DeterminationValue, string $ProfileSelection = ''): void
    {
        ...
        $this->UpdateFormField('SmokeDetectorDeterminationProgress', 'minimum', 0);
        $maximumVariables = count(IPS_GetVariableList());
        $this->UpdateFormField('SmokeDetectorDeterminationProgress', 'maximum', $maximumVariables);
        ...
        foreach (@IPS_GetVariableList() as $variable) {
            switch ($DeterminationType) {
                ...
                case 1: //Ident: SMOKE_DETECTOR_ALARM_STATUS
                    $determineIdent = true;
                    break;
            ...
            $passedVariables++;
            $this->UpdateFormField('SmokeDetectorDeterminationProgress', 'visible', true);
            $this->UpdateFormField('SmokeDetectorDeterminationProgress', 'current', $passedVariables);
            $this->UpdateFormField('SmokeDetectorDeterminationProgressInfo', 'visible', true);
            $this->UpdateFormField('SmokeDetectorDeterminationProgressInfo', 'caption', $passedVariables . '/' . $maximumVariables);
            IPS_Sleep(10);
        ...
        if (empty($determinedVariables)) {
            $this->UpdateFormField('SmokeDetectorDeterminationProgress', 'visible', false);
            $this->UpdateFormField('SmokeDetectorDeterminationProgressInfo', 'visible', false);
            if ($amount > 0) {
        ...
        $this->UpdateFormField('DeterminedSmokeDetectorVariableList', 'visible', true);
        $this->UpdateFormField('DeterminedSmokeDetectorVariableList', 'rowCount', count($determinedVariables));
        $this->UpdateFormField('DeterminedSmokeDetectorVariableList', 'values', json_encode($determinedVariables));
        $this->UpdateFormField('OverwriteSmokeDetectorVariableProfiles', 'visible', true);
        $this->UpdateFormField('ApplyPreSmokeDetectorTriggerValues', 'visible', true);
    }

    /**
     * Applies the determined smoke detector variables to the smoke detector list.
     *
     ...
     * @throws Exception
     */
    public function ApplyDeterminedSmokeDetectorVariables(object $ListValues, bool $OverwriteVariableProfiles): void
    {
        $determinedVariables = [];
        ...
        foreach ($variables as $variable) {
            ...
            if ($OverwriteVariableProfiles) {
                ...
                switch ($variableType) {
                    ...
                    case 1: //Integer
                        $profileName = 'SmokeDetector.Integer';
                        break;
        ...
        @IPS_SetProperty($this->InstanceID, 'SmokeDetectors', json_encode(array_values($listedVariables)));
    ...
    /**
     * Gets the actual smoke detector states.
     *
     * @return void
     * @throws Exception
     */
    public function GetActualSmokeDetectorStates(): void
    {
        $this->SendDebug(__FUNCTION__, 'wird ausgeführt', 0);
        $this->UpdateFormField('ActualSmokeDetectorStateConfigurationButton', 'visible', false);
    ...
    /**
     * Assigns variable profiles to the smoke detector variables.
     *
     * @return void
     * @throws Exception
     */
    public function AssignSmokeDetectorVariableProfile(): void
    {
        ...
        $this->UpdateFormField('AssignSmokeDetectorVariableProfileProgress', 'minimum', 0);
        $this->UpdateFormField('AssignSmokeDetectorVariableProfileProgress', 'maximum', $maximumVariables);
        $passedVariables = 0;
        ...
        if ($maximumVariables == 0) {
            ...
            $this->UpdateFormField('AssignSmokeDetectorVariableProfileProgress', 'visible', false);
            $this->UpdateFormField('AssignSmokeDetectorVariableProfileProgressInfo', 'visible', false);
     ...
     * @throws Exception
     */
    public function CheckSmokeDetectorAlerting(int $SenderID, bool $ValueChanged): bool
    {
        $this->SendDebug(__FUNCTION__, 'wird ausgeführt', 0);
                ...
                if ($primaryCondition != '') {
                    if (array_key_exists(0, $primaryCondition)) {
                        if (array_key_exists(0, $primaryCondition[0]['rules']['variable'])) {
                            ...
                            if ($id == $SenderID) {
                                if (!$variable['Use']) {
                                    $this->SendDebug(__FUNCTION__, 'Abbruch, der Rauchmelder ist nicht aktiviert!', 0);
                                    return false;
                                }
                                ...
                                $alerting = false;
                                if (IPS_IsConditionPassing($variable['PrimaryCondition']) && IPS_IsConditionPassing($variable['SecondaryCondition'])) {
                                    $this->SendDebug(__FUNCTION__, 'Die Bedingungen wurden erfüllt. Der Rauchmelder hat Rauch erkannt!', 0);
                                    $open = true;
                                }
                                if ($variable['PermanentMonitoring']) {
                                    ...
                                    switch ($this->GetValue('AlarmZoneDetailedState')) {
                                        case 0: //disarmed
                                            $this->SendDebug(__FUNCTION__, 'Alarmzone ist unscharf! Rauchmelder ohne Auslösefunktion!', 0);
                                            break;
                                        ...
                                        case 4: //delayed partial armed
                                            $this->SendDebug(__FUNCTION__, 'Alarmzone ist verzögert scharf! Rauchmelder ohne Auslösefunktion!', 0);
                                        break;
                                ...
                                if ($alerting) {
                                    $timeStamp = time();
                                    //Status verification
                                    if ($variable['AlertingSmokeDetectorStatusVerificationDelay'] > 0) {
                                        $this->SendDebug(__FUNCTION__, 'Status wird in ' . $variable['AlertingSmokeDetectorStatusVerificationDelay'] . ' Millisekunden erneut geprüft!', 0);
                                        $scriptText = self::MODULE_PREFIX . '_VerifyAlertingSmokeDetectorStatus(' . $this->InstanceID . ', ' . $SenderID . ', ' . $variable['AlertingSmokeDetectorStatusVerificationDelay'] . ');';
                                    ...
                                    if ($variable['UseNotification']) {
                                        $this->SendNotification('SmokeDetectorAlarmNotification', (string) $variable['Designation']);
                                    }
                                    //Options
    ...
    /**
     * Verifies the smoke detector alerting again after a delay.
     *
     * @param int $SenderID
     * @param int $Delay
     * @return void
     * @throws Exception
     */
    public function VerifyAlertingSmokeDetectorStatus(int $SenderID, int $Delay): void
    {
        $this->SendDebug(__FUNCTION__, 'wird ausgeführt', 0);
        $this->SendDebug(__FUNCTION__, 'Sender: ' . $SenderID, 0);
        $this->SendDebug(__FUNCTION__, 'Verzögerung: ' . $Delay, 0);
        $sensors = json_decode($this->ReadAttributeString('VerificationSmokeDetectors'));
        //Add new sender id
        $sensors[] = $SenderID;
        $this->WriteAttributeString('VerificationSmokeDetectors', json_encode($sensors));
        IPS_Sleep($Delay);
        $variables = json_decode($this->ReadPropertyString('SmokeDetectors'), true);
        foreach ($variables as $variable) {
            if (array_key_exists('PrimaryCondition', $variable)) {
                ...
                if ($primaryCondition != '') {
                    if (array_key_exists(0, $primaryCondition)) {
                        if (array_key_exists(0, $primaryCondition[0]['rules']['variable'])) {
                            ...
                            if ($id == $SenderID) {
                                if (!$variable['Use']) {
                                    $this->RemoveSmokeDetectorVerification($SenderID);
                                    return;
                                }
                                $smokeDetection = false;
                                $alerting = false;
                                if (IPS_IsConditionPassing($variable['PrimaryCondition']) && IPS_IsConditionPassing($variable['SecondaryCondition'])) {
                                    $this->SendDebug(__FUNCTION__, 'Der Status wurde erneut geprüft. Der Rauchmelder hat Rauch erkannt!', 0);
                                    $smokeDetection = true;
                                }
                                if ($variable['PermanentMonitoring']) {
                                    if ($smokeDetection) {
    ...
    /**
     * Configures the verification delay for the smoke detectors.
     *
     * @param int $Delay
     * @return void
     * @throws Exception
     */
    public function ConfigureSmokeDetectorVerificationDelay(int $Delay): void
    {
        ...
        $listedVariables = json_decode($this->ReadPropertyString('SmokeDetectors'), true);
        $maximumVariables = count($listedVariables);
        $this->UpdateFormField('SmokeDetectorVerificationDelayProgress', 'minimum', 0);
        $this->UpdateFormField('SmokeDetectorVerificationDelayProgress', 'maximum', $maximumVariables);
        $passedVariables = 0;
        foreach ($listedVariables as $key => $variable) {
            $passedVariables++;
            $this->UpdateFormField('SmokeDetectorVerificationDelayProgress', 'visible', true);
            $this->UpdateFormField('SmokeDetectorVerificationDelayProgress', 'current', $passedVariables);
            $this->UpdateFormField('SmokeDetectorVerificationDelayProgressInfo', 'visible', true);
            $this->UpdateFormField('SmokeDetectorVerificationDelayProgressInfo', 'caption', $passedVariables . '/' . $maximumVariables);
            IPS_Sleep(200);
            $listedVariables[$key]['AlertingSmokeDetectorStatusVerificationDelay'] = $Delay;
        }
        @IPS_SetProperty($this->InstanceID, 'SmokeDetectors', json_encode(array_values($listedVariables)));
        if (@IPS_HasChanges($this->InstanceID)) {
            @IPS_ApplyChanges($this->InstanceID);
    ...
    /**
     * Creates profiles for the smoke detectors.
     *
     * @return void
     */
    private function CreateSmokeDetectorVariableProfiles(): void
    {
        ...
        IPS_SetVariableProfileIcon($profile, 'Flame');
        IPS_SetVariableProfileAssociation($profile, 0, 'Rauch erkannt', '', 0xFF0000);
        IPS_SetVariableProfileAssociation($profile, 1, 'OK', '', 0x00FF00);

        //Integer variable
        $profile = 'SmokeDetector.Integer';
        if (!IPS_VariableProfileExists($profile)) {
        ...
        $profile = 'SmokeDetector.Integer.Reversed';
        if (!IPS_VariableProfileExists($profile)) {
            IPS_CreateVariableProfile($profile, 1);
        }
        IPS_SetVariableProfileIcon($profile, 'Window');
    ...
    /**
     * Removes a sensor from the smoke detector verification list.
     *
     * @param int $SensorID
     * @return void
     * @throws Exception
     */
    private function RemoveSmokeDetectorVerification(int $SensorID): void
    {
        $sensors = json_decode($this->ReadAttributeString('VerificationSmokeDetectors'), true);
    ...
    /**
     * Checks the state of all activated smoke detectors.
     *
     * @return bool
     * false =  ok,
     * true =   smoke alarm
